...
QT_MOC_LITERAL(1, 13, 18), // "targetTypeSelected"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 10), // "TargetType"
QT_MOC_LITERAL(4, 44, 4), // "type"
QT_MOC_LITERAL(5, 49, 15), // "onButtonToggled"
QT_MOC_LITERAL(6, 65, 16), // "QAbstractButton*"
QT_MOC_LITERAL(7, 82, 6), // "button"
QT_MOC_LITERAL(8, 89, 7) // "checked"

    },
    "SettingsPage\0targetTypeSelected\0\0"
    "TargetType\0type\0onButtonToggled\0"
...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->targetTypeSelected((*reinterpret_cast< TargetType(*)>(_a[1]))); break;
        case 1: _t->onButtonToggled((*reinterpret_cast< QAbstractButton*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (SettingsPage::*)(TargetType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::targetTypeSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsPage::targetTypeSelected(TargetType _t1)
{
